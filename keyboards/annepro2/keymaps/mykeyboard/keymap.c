...
*/
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 */
	KC_AP2_BT_UNPAIR, KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_AP2_BT4, KC_MUTE, KC_VOLD, KC_VOLU, KC_AP_LED_OFF, KC_AP_LED_ON, KC_AP_LED_NEXT_INTENSITY, KC_AP_LED_SPEED, _______, _______,
    _______, _______,    KC_UP,      _______,    _______,    _______, _______, _______, _______, _______, KC_PSCR, _______, _______,  _______,
    _______, KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,
    _______,             _______,    _______,    _______,    _______, _______, _______, KC_HOME, KC_END,  KC_INS,  KC_DEL,  _______,
...
bool led_update_user(led_t leds) {
    if (leds.caps_lock) {
		...
		ap2_led_mask_set_key(3, 0, color);
    } else {
